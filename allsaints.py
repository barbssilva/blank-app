...
def traducao(excel_output1):
    traducao_dict={"armhole straight":"CAVA A DIREITO",
        ...
        "front length - snp to bottom hem edge":"COMPRIMENTO FRENTE DESDE PO",
        "front length - snp to bottom hem edge - straight":"COMPRIMENTO FRENTE DO PO - A DIREITO",
        ...
        "bust - measured at {num}cm below underarm": "PEITO - {num}CM ABAIXO DA CAVA",
        "chest-measured at {num}cm below underarm": "PEITO - {num}CM ABAIXO DA CAVA",
        "forearm width {num} below underam":"ANTEBRAÇO - {num}CM ABAIXO DA CAVA",
        "high hip width - {num}cm below waist edge":"ANCA ALTA - {num} CM DA COSTURA DO CINTO",
        "hood width {num}cm down inc trim":"LARGURA DO CAPUCHO A {num} CM INCLUÍ BAINHA",
        ...
        "thigh width - at {num}cm below crotch":"LARGURA DA COXA - {num} CM ABAIXO DA VIRILHA",
